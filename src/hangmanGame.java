...
/**
 * This class is where the magic happens --the game will be played here.
 * @author Abdulaziz
 */
public class hangmanGame {
     ...
     * @throws IOException 
     */
    public hangmanGame(Socket clientSocket, BufferedReader in, PrintWriter out, String word) throws IOException {
    ...
    public void startGame() throws IOException {
        out.println("Welcome to new hangman game");
